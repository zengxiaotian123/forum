	...
	<div class="row-fluid">
		...
		<div class="span10">
			<ul class="breadcrumb">
				...
				<li>
					<a href="#">Struts2[版块名称]</a> <span class="divider">/</span>
				</li>
				<li class="active">
					发起话题
				</li>
			...
			<div class="row-fluid">
				...
				<div class="span8">
					<form class="form-horizontal form-inline" role="form" style="text-align:center;margin-top:50px;border:2px #f5f5f5 solid;">
						<fieldset>
							<legend style="text-align:center;">发布新话题</legend>
   							...
   							<div class="form-group" style="margin-top:20px;margin-bottom:20px;">
      							<input style="width:80%;height:40px;" type="file" id="inputfile">
   							</div>

	   						<div class="form-group" style="margin-top:20px;margin-bottom:20px;">
									<button type="submit" style="width:20%" class="btn btn-default">发布</button>
