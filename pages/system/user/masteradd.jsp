...
<div class="container-fluid">
	<div class="row-fluid">
		...
		<div class="span10">
			...
			<form class="form-horizontal form-inline" role="form" style="margin-top:80px;text-align:center;border:1px #f5f5f5 solid;">
				<fieldset>

					<div class="form-group" style="margin-top:20px;margin-bottom:20px;">
						版块名称
						<input  style="width:60%;height:40px;" type="text" class="form-control" id="title" placeholder="请输入版块名称...">
					</div>
					
					<div class="form-group" style="margin-top:20px;margin-bottom:20px;">
						用户名称
						<input  style="width:60%;height:40px;" type="text" class="form-control" id="name" placeholder="请输入用户名称	...">
					</div>
