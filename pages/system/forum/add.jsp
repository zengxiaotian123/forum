			...
			<form class="form-horizontal form-inline" role="form" style="text-align:center;border:1px #f5f5f5 solid;">
				<fieldset>
					...
					<div class="form-group" style="margin-top:20px;margin-bottom:20px;">
						<input  style="width:60%;height:40px;" type="text" class="form-control" id="name" placeholder="请输入版块名称...">
					</div>
					
					<div class="form-group" style="margin-top:20px;margin-bottom:20px;">
						<input  style="width:60%;height:40px;" type="text" class="form-control" id="order" placeholder="请输入显示顺序...">
					</div>

					<div class="form-group" style=";margin-top:20px;margin-bottom:20px;">
						<textarea  style="width:60%;" class="form-control" rows="5" id="desc">请输入版块简介...</textarea>
					</div>
					
					<div class="form-group" style=";margin-top:20px;margin-bottom:20px;">
						<textarea  style="width:60%;" class="form-control" rows="10" id="rule">请输入版块规则...</textarea>
					</div>
