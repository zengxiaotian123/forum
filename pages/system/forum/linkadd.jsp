			...
			<form class="form-horizontal form-inline" role="form" style="text-align:center;border:1px #f5f5f5 solid;">
				<fieldset>
					...
					<div class="form-group" style="margin-top:20px;margin-bottom:20px;">
						链接标题
						<input  style="width:60%;height:40px;" type="text" class="form-control" id="title" placeholder="请输入链接标题...">
					</div>
					
					<div class="form-group" style="margin-top:20px;margin-bottom:20px;">
						链接说明
						<input  style="width:60%;height:40px;" type="text" class="form-control" id="content" placeholder="请输入文字说明...">
					</div>
						
					<div class="form-group" style="margin-top:20px;margin-bottom:20px;">
						链接地址
						<input  style="width:60%;height:40px;" type="text" class="form-control" id="url" placeholder="请输入链接地址...">
					</div>
